	...
	return (
		<div>
			<div className="grid grid-cols-[1fr_469px] gap-6">
				<Card className="bg p-3 dark:border border-[#1C252E]">
						...
						<div className="grid grid-cols-[1fr_260px] gap-5 h-full items-center">
							...
							<div className="max-w-[260px]">
								...
								>
									...
									<image
										href="https://assets.minimals.cc/public/assets/illustrations/characters/character-3.webp"
										height="300"
										x="312"
										y="30"
									></image>
				...
				<Card className="ballance-bg dark:border border-[#1C252E]">
					<CardContent className="relative h-full flex items-center justify-center">
						<div>
							<h1 className="text-center text-5xl font-bold mb-1 text-white">
								${mainAccount?.totalBalance}
							</h1>
						</div>
						<p className="absolute bottom-0 text-center text-2xl font-medium text-white opacity-65">
							Account balance
						</p>
					</CardContent>
				</Card>
			...
			<div className="flex justify-between gap-6 mt-6">
				{/* income */}
				<div className="flex items-center bg-green-100 h-[80px] rounded-3xl px-4 py-[17px] w-full">
					<div className="flex items-center justify-center h-[48px] w-[48px] bg-snow-white rounded-2xl mr-2.5 text-green-100">
						<IncomeIcon />
					</div>
					<div>
						<p className="font-medium text-sm text-snow-white">Income</p>
						<p className="text-snow-white text-[22px] font-semibold">
				...
				{/* Expenses */}
				<div className="flex items-center bg-red-100 h-[80px] rounded-3xl px-4 py-[17px] w-full">
					<div className="flex items-center justify-center h-[48px] w-[48px] bg-snow-white rounded-2xl mr-2.5 text-red-100">
						<ExpenseIcon />
					</div>
					<div>
						<p className="font-medium text-sm text-snow-white">Expenses</p>
						<p className="text-snow-white text-[22px] font-semibold">
